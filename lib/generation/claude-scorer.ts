...
- FOOD & CPG ONLY: Lewisco exclusively deals in food, beverage, pet food, health & beauty, and household consumer products. SKIP any company primarily in: automotive, technology, software, financial services, real estate, construction, manufacturing equipment, aerospace, defense, energy, oil & gas, telecommunications, media, entertainment, apparel/fashion, furniture, agriculture (non-food), chemicals, pharmaceuticals (Rx), medical devices, or any other non-consumer-goods industry. If you are not confident the company makes or sells physical consumer products in Lewisco's categories — skip it entirely.
