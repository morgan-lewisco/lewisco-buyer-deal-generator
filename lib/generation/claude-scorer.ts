...
- FOOD & BEVERAGE / PET FOOD ONLY: Lewisco exclusively deals in shelf-stable, frozen, and refrigerated PACKAGED food & beverage and pet food. SKIP any company primarily in: health & beauty, personal care, household cleaning products, automotive, technology, software, financial services, real estate, construction, manufacturing equipment, aerospace, defense, energy, oil & gas, telecommunications, media, entertainment, apparel/fashion, furniture, agriculture (non-food), chemicals, pharmaceuticals (Rx), or medical devices.
- NO FRESH/PERISHABLE PRODUCE: SKIP any company whose primary business is fresh produce, raw fruits and vegetables, fresh-cut salads, or any product with a very short shelf life that cannot be closeout-sold. Examples to skip: fresh lettuce growers, berry farms, fresh-cut produce companies.
- NO RAW MEAT OR DAIRY PROCESSING: SKIP companies whose primary business is raw meat processing/packing (beef, pork, poultry slaughter and processing) or raw dairy processing (milk, cheese, butter manufacturing from raw milk). These products are perishable and not suitable for closeout deals. Examples to skip: beef packing plants, poultry processing facilities, fluid milk processors. HOWEVER — do include branded PACKAGED meat snacks (jerky, meat sticks), canned meat, or shelf-stable dairy-based snacks if those are the brand's primary products.
- If you are not confident the company makes packaged, shelf-stable or frozen food, beverage, or pet food for consumer sale — skip it entirely.
