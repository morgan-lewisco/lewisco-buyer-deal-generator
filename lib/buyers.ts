...
export const BUYER_NAMES = ['Dewey Yeager', 'Igor Vega', 'Edward Rivers', 'Donny Carter', 'Jesse Kroll', 'Alex Chaney', 'Evan Jaslow', 'Jeff Halliday', 'Adam Gibson', 'Jason Sanders'];
...
export const GLOBAL_PROFILE: BuyerProfile = {
  ...
  bio: 'Full-spectrum closeout buyer: frozen, refrigerated, dry grocery, beverages, snacks, candy, and pet food.',
  badge: { label: 'Global Pool', color: 'slate', emoji: '🌐' },
  zohoOwnerName: '',
  lanes: [
    'branded CPG food & beverage closeouts',
    'frozen & refrigerated packaged food surplus',
    'dry grocery & shelf-stable overstock',
    'beverages — juice, functional soda, water, coffee, energy drinks',
    'snacks, popcorn, candy, cookies & confectionery',
    'canned & shelf-stable grocery',
    'sports nutrition & supplements',
    'Hispanic / international / specialty imports',
    'sweeteners, baking ingredients & pantry staples',
  ...
  categories: [
    ...
    'Canned Grocery', 'Condiments', 'International Foods',
    'Sports Nutrition', 'Pet Food',
    'Frozen Foods', 'Refrigerated Packaged Foods',
  ],
  seedVendors: [
